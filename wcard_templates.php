...
<head>
<title>
CardStore---Wedding Card Templates !!
</title>
<meta charset="utf-8">
...
.dropdown-content a {
    color: #516ca1; background-color:white;
...
<body background="images\grey-back.jpg" >
<div id="wrapper">
<div class="heads" >



<p class="acc_n_crt" align=right><!--img src="images\myAcc.jpg" height=20px width=15px--><span class="glyphicon glyphicon-user">&nbsp<a href="#">My Account</a>&nbsp|&nbsp<!--img src="images\Shopping_cart.jpg" height=20px width=15px --><span class="glyphicon glyphicon-shopping-cart">&nbsp<a href="\CardStore\cart.php" onclick="val();">My Cart</a>&nbsp|&nbsp<!--img src="\CardStore\images\logout.jpg" height=20px width=15px--><span class="glyphicon glyphicon-off">&nbsp<a href="\CardStore\logout.php">Logout</a>&nbsp&nbsp</p>
...
<ul style="list-style-type:none;background-color:#28304d;display:block;margin:0;padding:0;width:900px;height:60px;">
	...
	<li class="nav1"><a href="#" class="drop">Category</a>
 		<div class="dropdown-content" style="z-index:20;">
      			<a href="vcard_templates.php">Visiting Cards</a>
      			<a href="\CardStore\vcard_templates.php">Wedding Cards</a>
      			<a href="\CardStore\tcard_templates.php">Thank You Cards</a>
    		</div></li>
	<li class="nav2"><a href="\CardStore\AboutUs.php">About Us</a></li>
</ul>
<div class="content">
<h2><font size=11 color=#F7468A face="Comic Sans MS">&nbsp&nbsp&nbspWedding Cards</font></h2><br>
<?php 
$retrieveWC="SELECT * FROM `product` WHERE `p_init`='WC'";
$resultWC=mysqli_query($connect,$retrieveWC);

$num=1;
$link_address="Personalization\PersonalizationW0";
$extn=".php";
while($row=mysqli_fetch_array($resultWC))
{?>
