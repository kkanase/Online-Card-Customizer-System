...
$id_no=mysqli_query($connect,"SELECT * FROM product WHERE p_name='whitF Wedding Card'");
...
<br>
<img src="\CardStore\images\whitF.jpg" height=600px width=550px >
...
<br><br>
<img src="\CardStore\images\whitB.jpg" height=600px width=550px style="position=relative;"><br>
<br>
<p id="e8">Name</p>
<p id="h3">Weds</p>
<p id="e9">Name</p>
...
<p style="text-align:center;color: #E62E6B;"><b>This is a Flat Wedding Invitation Card .Also it includes a free white Envelope!!<b></p>
