...
session_start();
$id_no=mysqli_query($connect,"SELECT * FROM product WHERE p_name='butterF Thank You Card'");
...
header("Location:/CardStore//CardStore/Login.php");
}?>
<html>
<head>
<title>
...
<input type="text" id="nm" name="nm" placeholder="Jane & Jimmy" oninput="val2()"><br><br>
...
<img src="\CardStore\images\butterF.jpg" height=230px width=400px >
<p id="e" >Add Your Message</p><br>
...
<img src="\CardStore\images\butterB.jpg" height=230px width=400px style="position=relative;"><br>
<br>
...
<p style="text-align:center;color: #E62E6B;">Rs 50</p><br></div><br>
</div>
