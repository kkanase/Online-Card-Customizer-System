...
$id_no=mysqli_query($connect,"SELECT * FROM product WHERE p_name='maruF Thank You Card'");
...
<img src="\CardStore\images\maruF.jpg" height=230px width=400px >
<p id="e" >Add your Message</p><br>
<p id="e1" >Salutation</p><br>
<p id="e2" >Your Name</p><br>

<center style="display:block;color:white;background-color:#292a34;position:absolute;width:90px;">Back</center>
<img src="\CardStore\images\maruB.jpg" height=230px width=400px style="position=relative;"><br>
<br>
...
<p style="text-align:center;color: #E62E6B;">Rs 70</p><br></div><br>
</div>
