...
$id_no=mysqli_query($connect,"SELECT * FROM product WHERE p_name='ganuF Wedding Card'");
...
{ var i= confirm("Do you approve the details you have filled?");
  ...
  {  document.getElementById("pro").disabled = false;  
     alert("I have reviewed and approve my design.");   
  }
  else
  {
...
<textarea  id="venue" name="venue" oninput="val6()" rows="5" cols="27"></textarea><br>
...
<br>
<img src="\CardStore\images\ganuF.jpg" height=450px width=550px >
<p id="e0" align=right>Bride's Name</p><br>
<p id="e1" align=right>Daughter of.......</p><br>
<p id="h1" >And</p><br>
<p id="e2" align=left>Groom's Name</p><br>
<p id="e3" align=left>Son of.......</p><br>
<p id="e10">Add a Request Line.........</p><br>
<p id="e4" align=right>Add a Wedding Date.........</p><br>
<p id="e5" align=right>Add the Event Time.........</p><br>
<p id="h2" >--|Venue|--</p>
<p id="e6" align=right>Add the Venue Details.........</p>
...
<br><br>
<img src="\CardStore\images\ganuB.jpg" height=450px width=550px style="position=relative;"><br>
<br>
<p id="e8">Name</p>
<p id="h3">Weds</p>
<p id="e9">Name</p>
<center><input type="button" onMouseover="this.style.background = '#0067a7'" onMouseout="this.style.background = '#00477e'"
   value="APPROVE" class="APPROVE_button" onclick="approve()"></input></center>
<br></div><br>

<div class="about" >
<center><legend><b><font face="Harrington" size="5" color="#00468C">About this card</font></b></legend></center>
<p style="text-align:center;color: #E62E6B;"><b>This is a Flat Wedding Invitation Card with pale yellow color and a ganesha symbol.It also include a white envelope<b></p>

<b><font color=#215097 size="3">Size</font></b>
<p style="text-align:center;color: #E62E6B;">5.47 x 4.21 inch Flat Card</p>
...
<p style="text-align:center;color: #E62E6B;">Rs 110</p><br></div><br>
</div>
