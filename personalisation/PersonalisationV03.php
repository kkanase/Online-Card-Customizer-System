...
include "connect.php";
error_reporting(0);
$id_no=mysqli_query($connect,"SELECT * FROM product WHERE p_name='triaF Visiting Card'");
...
function option()
{window.onbeforeunload = null;window.location.assign("/CardStore/Add_to_cart.php");
}
</script>
</head>
...
<img src="\CardStore\images\triaF.jpg" height=230px width=400px >
<p id="e" align=left>COMPANY NAME</p><br>
...
<img src="\CardStore\images\triaB.jpg" height=230px width=400px style="position=relative;"><br>
<br>
