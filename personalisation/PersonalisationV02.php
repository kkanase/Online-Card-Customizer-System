...
error_reporting(0);
$id_no=mysqli_query($connect,"SELECT * FROM product WHERE p_name='DesF Visiting Card'");
...
function option(){window.onbeforeunload = null;window.location.assign("/CardStore/Add_to_cart.php")
...
<input type="text" id="Vid" name="Vid" readonly value="<?php echo $_SESSION['cardID']; ?>" readonly><br>
...
<img src="\CardStore\images\desF.jpg" height=230px width=400px >
<p id="e" >COMPANY NAME</p><br>
<p id="e1" align=left>Your Name</p><br>
<p id="e2" align=left>Designation</p><br>
<p id="e3" align=right>Contact No.</p><br>
<p id="e4" align=left>Address</p><br>
...
<img src="\CardStore\images\desB.jpg" height=230px width=400px style="position=relative;"><br>
<br>
...
<ul class="under_footer">
	...
	<li class="lnk" ><a href="cardb.php" class="lnk_foot"><font face=Comic Sans MS>Cardstore Benefits</font></a></li><br>
		<li class="lnk" ><a href="policy.php" class="lnk_foot"><font face=Comic Sans MS>Our Policy</font></a></li><br>
</ul><br>
<p style="clear:both;">
<center>
