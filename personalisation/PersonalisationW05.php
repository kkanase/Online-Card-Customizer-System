...
$id_no=mysqli_query($connect,"SELECT * FROM product WHERE p_name='redgiF Wedding Card'");
...
<br>
<img src="\CardStore\images\redgiF.jpg" height=650px width=550px >
...
<br><br>
<img src="\CardStore\images\redgiB.jpg" height=650px width=550px style="position=relative;"><br>
<br>
<p id="e8">Name</p>
<p id="h3">Weds</p>
<p id="e9">Name</p>
