...
$id_no=mysqli_query($connect,"SELECT * FROM product WHERE p_name='mellowF Thank You Card'");
...
<img src="\CardStore\images\mellowF.jpg" height=230px width=400px >
...
<img src="\CardStore\images\mellowB.jpg" height=230px width=400px style="position=relative;"><br>
<br>
