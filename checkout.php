...
function gotolink()
{//window.location = chcky.php;
window.location.assign("chcky.php")
...
<div class="order">
<br>
<br><h1> Payment Method </h1>
<hr style=" border: 1px solid #00477e;">
<h3> Cash on delivery</h3>

<br>
<p>Do you want to change the delivery Address?</p>
 
<form class="myform" method='post' action="thanks.php" >

<div class='radio'>
<input type="radio"  name="sign_in" value="chcky.php"  onClick="gotolink()" ><label for="sign_in" >Yes, I want to.</label>
<br><br>
<input type="radio"  name="sign_in" value="checkout.php" checked ><label for="sign_in" >No,I don't want to.</label><br><br>
</div><input type="submit" value="Confirm" onMouseover="this.style.background = '#A7F432'"  onMouseout="this.style.background = '#299617'" class="confirmation"></input>
