...
<div id="wrapper">
<div class="heads" >
<p class="acc_n_crt" align=right><span class="glyphicon glyphicon-user">&nbsp<a href="#">My Account</a>&nbsp|&nbsp
<span class="glyphicon glyphicon-shopping-cart">&nbsp<a href="\CardStore\cart.php" onclick="val();">My Cart</a>&nbsp|&nbsp<span class="glyphicon glyphicon-off">&nbsp<a href="\CardStore\logout.php">Logout</a>&nbsp&nbsp</p>
...
<font Face="FORTE"  size=4>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp....Buy it</font></p></p>
<form >
...
<div class="content">
<h2><font size=11 color=#F7468A face="Comic Sans MS">&nbsp&nbsp&nbspVisiting Cards</font></h2><br>
<?php 
$retrieveVC="SELECT * FROM `product` WHERE `p_init`='VC'";
$resultVC=mysqli_query($connect,$retrieveVC);

$num=1;
$link_address="Personalization\PersonalizationV0";
$extn=".php";
